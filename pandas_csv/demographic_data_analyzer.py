...
def calculate_demographic_data(print_data=True):
    ...
    highest_earning_country = (df.loc[df['salary'] == ">50K"].value_counts('native-country')/df.value_counts('native-country')).idxmax()
    highest_earning_country_percentage = round((df.loc[df['salary'] == ">50K"].value_counts('native-country')/df.value_counts('native-country')).max() * 100,1)
